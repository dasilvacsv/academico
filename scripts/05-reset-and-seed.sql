-- Script para resetear completamente la base de datos y poblarla desde cero

-- Deshabilitar temporalmente las restricciones de clave foránea
SET session_replication_role = replica;

-- Truncar todas las tablas en el orden correcto
TRUNCATE TABLE pagos CASCADE;
TRUNCATE TABLE historial_academico CASCADE;
TRUNCATE TABLE grado_docente CASCADE;
